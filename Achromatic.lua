...
if v:IsA("Accessory") and not MESH_HATS[v.Name] and v.Handle:FindFirstChild("Mesh") then
...
for i,v in pairs(game.Players.LocalPlayer.Character:GetChildren()) do
if v:IsA("Accessory") and not MESH_HATS[v.Name] and v.Handle:FindFirstChild("SpecialMesh") then
...
--[[
https://www.roblox.com/catalog/4602617115/Blue-Crystal-Wings
https://www.roblox.com/catalog/4602619613/Red-Crystal-Wings
https://www.roblox.com/catalog/4602533885/Rainbow-Crystal-Wings
https://www.roblox.com/catalog/4611970333/Ice-Crystal-Wings
https://www.roblox.com/catalog/5063499736/Virus-Malware
...
for _,v in pairs(Char:GetChildren()) do
	if v:IsA("Accessory") and v.Name:find("Sword1") then
		table.insert(MPASword,v)
	end
end

for _,v in pairs(Char:GetChildren()) do
	if v:IsA("Accessory") and v.Name:find("Sword2") then
		table.insert(MPASword,v)
	end
end

for _,v in pairs(Char:GetChildren()) do
	if v:IsA("Accessory") and v.Name:find("Sword3") then
		table.insert(MPASword,v)
	end
end

for _,v in pairs(Char:GetChildren()) do
	if v:IsA("Accessory") and v.Name:find("Sword4") then
		table.insert(MPASword,v)
	end
end
...
if MPASword[1] then
	...
	athp.Position = Vector3.new(-10,-2,0)
...
if Char:FindFirstChild("Sword5") then
	...
	local HatChoice = Char:FindFirstChild("Sword5")
	HatChoice.Handle:FindFirstChildOfClass("AlignPosition").Attachment1 = athp
	HatChoice.Handle:FindFirstChildOfClass("AlignOrientation").Attachment1 = atho

	athp.Position = Vector3.new(-35,-1.7,0)
...
if MPASword[1] then
	...
	athp.Position = Vector3.new(-30,2.75,0)
	atho.Rotation = Vector3.new(0,0,45)
	table.remove(MPASword,1)
end
...
if MPASword[1] then
	...
	athp.Position = Vector3.new(20,-1.8,0)
	atho.Rotation = Vector3.new(0,0,45)
	table.remove(MPASword,1)
end
RWP2.Parent = rightWing
local RWP3 = WingPiece:Clone();
if Char:FindFirstChild("Sword6") then
	...
	local HatChoice = Char:FindFirstChild("Sword6")
	HatChoice.Handle:FindFirstChildOfClass("AlignPosition").Attachment1 = athp
	HatChoice.Handle:FindFirstChildOfClass("AlignOrientation").Attachment1 = atho

	athp.Position = Vector3.new(30,-1.75,0)
	atho.Rotation = Vector3.new(0,0,48)
end
